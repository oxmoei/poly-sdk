...
| **复杂度** | 简单、清晰（01-11）<br>生产级（12-13） | 完整、实用 |
| **生产就绪** | ⚠️ 部分（01-11 为教学用，12-13 为生产级） | ✅ 是（可直接使用） |
| **功能完整性** | 演示单个功能（01-11）<br>完整工作流程（12-13） | 完整的工作流程 |

> 💡 **注意**：示例 12-13 是**生产级版本**，包含完整的错误处理、结构化日志、配置验证、交易限额、指标收集等功能，可直接用于生产环境。
